...
<head>
    ...
    <title>Vegetable Cooking Oil FAQs - Palm Oil Admin</title>
            ...
            <div class="col-md-9 col-lg-10">
                <div class="main-content p-4">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        <h2>Vegetable Cooking Oil FAQs</h2>
                        <a href="faq-form.php" class="btn btn-success">
                        ...
                        <div class="card-body">
                            <?php if (empty($faqs)): ?>
                                <div class="text-center py-5">
                                    ...
                                    <a href="faq-form.php" class="btn btn-success">Add FAQ</a>
                                </div>
                            <?php else: ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($faqs as $faq): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge bg-secondary"><?php echo $faq['display_order']; ?></span>
                                                    </td>
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group btn-group-sm">
                                                            <a href="faq-form.php?id=<?php echo $faq['id']; ?>" 
